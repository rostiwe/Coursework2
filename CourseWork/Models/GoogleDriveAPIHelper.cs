...
namespace CourseWork.Models
{
    public class GoogleDriveAPIHelper
    {
        ...
        //    using (var stream = new FileStream(Path.Combine(CSPath, "client_secret_apps.googleusercontent.com.json"), FileMode.Open, FileAccess.Read))
        //    {
